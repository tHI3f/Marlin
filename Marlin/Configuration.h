...
#define STRING_CONFIG_H_AUTHOR "(Zalx)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alex Kossel"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 325.85 // get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -27.65  // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 32.5)
